...
try:
    from sentiment_mod import MainClassifier
...
short_pos = open(positive_train_file, "r").read()
short_neg = open(negative_train_file, "r").read()
...
save_to_file(algos_folder + "documents.pickle", "wb", documents)
...
save_to_file(algos_folder + "word_features5k.pickle", "wb", word_features)
